...
urlpatterns = [
    ...
    *_routes("mongodb-configs", "mongodbconfig", models.MongoDBConfig,
             views.MongoDBConfigListView, views.MongoDBConfigEditView, views.MongoDBConfigView,
             views.MongoDBConfigDeleteView, views.MongoDBConfigBulkDeleteView),
    *_routes("redis-configs", "redisconfig", models.RedisConfig,
             views.RedisConfigListView, views.RedisConfigEditView, views.RedisConfigView,
             views.RedisConfigDeleteView, views.RedisConfigBulkDeleteView),
    *_routes("mosquitto-configs", "mosquittoconfig", models.MosquittoConfig,
             views.MosquittoConfigListView, views.MosquittoConfigEditView, views.MosquittoConfigView,
             views.MosquittoConfigDeleteView, views.MosquittoConfigBulkDeleteView),
